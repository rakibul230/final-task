...
<center>
   ...
   <input style="background-color: lavender;" type="submit" value="update" name="register"> 
...
<?php
...

       {
        ...
        $query = "INSERT INTO doctor VALUES('$fname ' , '$lname', '$gender', '$address', '$phone' , '$email','$pwd', '$cpwd' ,'$qualification' )";
